				...
				<div class="row-fluid">
					...
					<div class="span8">
						...
						<?php echo $form->textField($model,'kode_transaksi',array('size'=>15,
							'maxlength'=>15,
							'class'=>'form-control',
							'value' => (($model->isNewRecord) ? $model->generateTransactionCodeAdd() : $model->kode_transaksi),
							'readonly'=>true)); ?>
						</div>
					</div>  
					...
					<div class="row-fluid">
						...
						<div class="row-fluid">
							<div class="span12">
								<?php echo CHtml::submitButton($model->isNewRecord ? 'Simpan' : 'Edit', array('class' => 'btn btn-info btn-lg pull-right')); ?>
							</div>
						</div>
